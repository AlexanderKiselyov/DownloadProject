namespace BelkaCloudDownloader.Gui
{
    ...
    public sealed partial class MainForm : Form
    {
        ...
        /// </summary>
        private readonly IList<CloudPlugin> plugins = new List<CloudPlugin> { new GoogleCloudPlugin(), new DropboxPlugin() };
                        ...
                        this.SelectedProtocols()
                            .Select(
                                ...
                                protocol.Execute(
                                    ...
                                    this.cancellationTokenSource.Token, this.currentOperationProgressBar)));
